...
//void exportBySensorID(TelemetryData* telemetryArray, int arraySize, FILE *outputFile) {
//    char sensorID[10];
...
//}
//
//void exportByLocation(TelemetryData* telemetryArray, int arraySize, FILE *outputFile) {
